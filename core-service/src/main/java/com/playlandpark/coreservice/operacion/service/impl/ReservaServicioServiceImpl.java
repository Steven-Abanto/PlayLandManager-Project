...
import com.playlandpark.coreservice.operacion.dto.reservaservicio.ReservaServicioRequest;
import com.playlandpark.coreservice.operacion.dto.reservaservicio.ReservaServicioResponse;
...
public class ReservaServicioServiceImpl implements ReservaServicioService {
    ...
    public ReservaServicioResponse create(ReservaServicioRequest request) {
        ...
        r.setIdProducto(request.idProducto());
    ...
    public List<ReservaServicioResponse> findByProducto(Integer idProducto) {
        ...
        return reservaServicioRepository.findByIdProducto(idProducto).stream().map(this::mapToResponse).toList();
    }
